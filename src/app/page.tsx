    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h2 className="font-headline text-3xl md:text-4xl font-bold mb-4">Discover Our Collection</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Explore our curated selection of premium eyewear, designed to blend timeless style with modern craftsmanship. Find the perfect pair to express your unique identity.
          </p>
        </div>
